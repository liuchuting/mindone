    ...
    def __call__(
        ...
        Args:
            ...
            generator (`ms.Generator`, *optional*):
                A [`ms.Generator`](https://pytorch.org/docs/stable/generated/torch.Generator.html) to make
        ...
        latents = self.vqvae.encode(image.to(dtype=self.vqvae.dtype)).latents
